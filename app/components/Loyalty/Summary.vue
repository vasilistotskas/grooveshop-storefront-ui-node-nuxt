...
en:
  points_section_title: "Points"
  level_section_title: "Level & Progress"
  points_tooltip: "Points can be redeemed for discounts on what you buy"
  level_tooltip: "Your level goes up with XP from orders and activity"
  coins_label: "Points"
  ...
  error_loading: "Could not load your data"
  retry: "Try again"
  earn_more_points: "Earn more points"
  shop_to_earn: "Shop to earn points and XP"
  learn_more: "Find out more"
  how_it_works: "How the rewards programme works"
  next_tier_unlocks: "Unlock the {tier} tier"
  next_tier_multiplier: "Unlocks a {bonus} points multiplier"
</i18n>
