...
en:
  no_tier: "No tier"
  tier_journey: "Tiers & Progress"
  slideover_description: "See every tier, what it takes and what it gives"
  current_tier_label: "Tier: {tier}"
  view_all_tiers: "See {count} tiers"
  ...
  max_xp: "Maximum XP"
  benefits: "Benefits"
  points_multiplier: "{bonus} points multiplier"
  faster_earning: "Earn points faster"
  how_it_works_title: "How It Works"
  how_it_works_1: "You earn XP on every order ({xp} XP = 1 level)"
  how_it_works_2: "Your level goes up automatically as you earn XP"
  how_it_works_3: "Higher levels unlock new tiers"
  formula: "Formula"
</i18n>
