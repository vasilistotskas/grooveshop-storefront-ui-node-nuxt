...
en:
  ...
  slideover_description: "View all tiers, requirements and benefits"
  current_tier_label: "Tier: {tier}"
  view_all_tiers: "View {count} tiers"
...
de:
  no_tier: "Keine Stufe"
  tier_journey: "Stufen & Fortschritt"
  slideover_description: "Alle Stufen, Anforderungen und Vorteile anzeigen"
  current_tier_label: "Stufe: {tier}"
  view_all_tiers: "{count} Stufen anzeigen"
  tier_progression: "Stufenfortschritt"
