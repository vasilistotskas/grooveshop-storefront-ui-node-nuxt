...
el:
  ...
  ready_to_confirm: Η πληρωμή είναι έτοιμη. Πατήστε το κουμπί παρακάτω για επιβεβαίωση.
  ...
  security_notice: Οι πληρωμές σας είναι ασφαλείς και κρυπτογραφημένες με SSL. Δεν αποθηκεύουμε τα στοιχεία της κάρτας σας.
</i18n>
