        ...
        >
          ...
          <MobileOrTabletOnly>
            <div
              ...
              "
            >
              <LazyWebsideSearchInput />
              <WebsideCartButton v-if="cartEnabled" />
              <LazyWebsideLanguageSwitcher v-if="locales.length > 1" />
              <UColorModeButton
                class="w-6"
                :ui="{
                  base: `
              ...
              />
              <ClientOnly>
                <LazyWebsideUserNotificationsBell v-if="loggedIn" />
                <template #fallback>
                  <UButton
                    v-if="loggedIn"
