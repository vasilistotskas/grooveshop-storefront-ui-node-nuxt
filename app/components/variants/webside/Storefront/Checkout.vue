...
<template>
  <WebsidePageWrapper class="max-w-6xl">
    <div class="flex flex-col gap-8 pt-2 md:pt-4 lg:flex-row">
      <!-- Main Content -->
      <div class="flex-1">
        <!-- Stock Error Alert -->
        <WebsideCheckoutStockErrorAlert
        ...
        <NuxtErrorBoundary @error="onBoundaryError">
          ...
          <WebsideCheckoutOnlinePaymentView
          ...
          <WebsideCheckoutStepPersonalInfo
        ...
        <div class="lg:sticky lg:top-4">
          ...
          >
            ...
            <template #loyalty>
              ...
              <WebsideCheckoutGuestLoyaltyCTA v-else />
            </template>

            <template #points-earned>
              <!-- Loyalty Points Earned Preview -->
              <WebsideCheckoutPointsEarned />
            </template>
