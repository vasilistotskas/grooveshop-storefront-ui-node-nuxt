...
<template>
  <WebsidePageWrapper class="flex flex-col">
    ...
    >
      <WebsideProductsSidebar id="filters" ref="sidebarRef" />
      <WebsideProductsList id="main-content" @toggle-filters="handleToggleFilters" />
    </div>
  </WebsidePageWrapper>
</template>
