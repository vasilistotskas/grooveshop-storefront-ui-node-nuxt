  ...
  <DefineFiltersTemplate>
    <div class="flex flex-col">
      ...
      <div class="space-y-2 pb-4">
        <WebsideProductsFiltersSearchInput />
      </div>
      ...
      >
        ...
        <template #price>
          <WebsideProductsFiltersPriceRange />
        </template>

        <!-- Popularity Filter -->
        <template #popularity>
          <WebsideProductsFiltersPopularityFilter />
        </template>

        <!-- View Count Filter -->
        <template #views>
          <WebsideProductsFiltersViewCountFilter />
        </template>

        <!-- Categories Filter -->
        <template #categories>
          <WebsideProductsFiltersCategoryFilter />
        </template>

        <!-- Attributes Filter -->
        <template #attributes>
          <WebsideProductsFiltersAttributeFilter />
        </template>
      </UAccordion>
      ...
      <WebsideProductsFiltersActiveFilters />
    </div>
  </DefineFiltersTemplate>
