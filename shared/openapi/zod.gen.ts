...
export const zPageConfigRetrieveData = z.object({
    body: z.never().optional(),
    path: z.object({
        pageType: z.string()
    }),
...
export const zPageConfigAdminListData = z.object({
    body: z.never().optional(),
    path: z.never().optional(),
    query: z.object({
        cursor: z.string().register(z.globalRegistry, {
...
export const zPageConfigAdminCreateData = z.object({
    body: zPageLayoutRequest,
    path: z.never().optional(),
    query: z.object({
        languageCode: z.enum([
            'de',
...
export const zPageConfigAdminDestroyData = z.object({
    body: z.never().optional(),
    path: z.object({
        id: z.union([
            z.string().regex(/^-?\d+$/),
...
export const zPageConfigAdminRetrieveData = z.object({
    body: z.never().optional(),
    path: z.object({
        id: z.union([
            z.string().regex(/^-?\d+$/),
...
export const zPageConfigAdminPartialUpdateData = z.object({
    body: zPatchedPageLayoutRequest.optional(),
    path: z.object({
        id: z.union([
            z.string().regex(/^-?\d+$/),
            z.int()
...
export const zPageConfigAdminUpdateData = z.object({
    body: zPageLayoutRequest,
    path: z.object({
        id: z.union([
            z.string().regex(/^-?\d+$/),
...
export const zTenantResolveRetrieveData = z.object({
    body: z.never().optional(),
    path: z.never().optional(),
    query: z.object({
        domain: z.string()
