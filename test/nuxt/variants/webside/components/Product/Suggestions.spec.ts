...
import Suggestions from '~/components/variants/webside/Product/Suggestions.vue'
...
const stubs = {
  ...
  LazyWebsideButtonProductAddToFavourite: true,
  WebsideButtonProductAddToCart: addToCartStub,
  LazyWebsideButtonProductAddToCart: addToCartStub,
  LazyUCarousel: {
    props: ['items'],
