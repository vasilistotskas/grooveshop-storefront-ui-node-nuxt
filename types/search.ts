...
export function ZodSearchResult<T>(zodSchema: z.ZodType<T>): z.ZodType<SearchResult<T>> {
	return z.object({
...
export const ZodSearchProductCategoryResult = ZodSearchResult(ZodSearchProductCategory)

export const ZodSearchResults = z.object({
	products: z.union([z.undefined(), z.null(), ZodSearchProductResult]),
	productCategories: z.union([z.undefined(), z.null(), ZodSearchProductCategoryResult])
})
...
export type SearchProductTranslations = z.infer<typeof ZodSearchProductTranslations>
