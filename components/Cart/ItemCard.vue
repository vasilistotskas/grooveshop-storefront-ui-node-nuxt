...
<template>
  <div
    v-if="cartItem"
    class="relative grid grid-cols-auto-1fr items-center justify-center justify-items-center gap-4 rounded-md border border-gray-900/10 bg-white p-2 dark:border-gray-50/[0.2] dark:bg-zinc-800 md:p-4"
  >
    <div class="grid">
      <div class="image">
