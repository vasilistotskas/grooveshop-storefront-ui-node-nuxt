					...
					>
						<div
							...
							:class="{
								...
								'text-slate-500 dark:text-primary-100 group-hover:bg-zinc-200 bg-zinc-100 dark:group-hover:bg-zinc-600 dark:bg-zinc-700':
									i !== 1
							}"
						>
						...
						<span
							class="text-sm font-semibold capitalize text-primary-700 dark:text-primary-100"
							:class="{
