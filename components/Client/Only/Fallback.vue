...
<template>
  ...
  >
    ...
    <p
      v-if="text"
      class="text-primary-800 dark:text-primary-100 absolute left-1/2 top-1/2 grid -translate-x-1/2 -translate-y-1/2 transform place-items-center font-semibold"
